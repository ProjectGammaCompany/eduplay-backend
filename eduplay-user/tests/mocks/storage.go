...
// PutUsername provides a mock function with given fields: ctx, in
func (_m *Storage) PutUsername(ctx context.Context, in *eduplay_user_v1.Profile) (string, error) {
	ret := _m.Called(ctx, in)

	if len(ret) == 0 {
		panic("no return value specified for PutUsername")
	}
