...
type UseCase interface {
	...
	DeleteEventById(ctx context.Context, pd *eventModel.Id) (string, error)
}

func New(log *slog.Logger, uc UseCase) http.HandlerFunc {
	return func(writer http.ResponseWriter, request *http.Request) {
		const op = "handlers.event.deleteEventById"
		...
		ret, err := uc.DeleteEventById(request.Context(), &req)
