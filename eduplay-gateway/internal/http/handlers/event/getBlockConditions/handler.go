...
type UseCase interface {
	...
	GetBlockConditions(ctx context.Context, pd *eventModel.Id) (*eventModel.Conditions, error)
}

func New(log *slog.Logger, uc UseCase) http.HandlerFunc {
	return func(writer http.ResponseWriter, request *http.Request) {
		const op = "handlers.event.getBlockConditions"
		...
		ret, err := uc.GetBlockConditions(request.Context(), &req)
