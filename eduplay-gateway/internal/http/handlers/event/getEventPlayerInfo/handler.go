...
type UseCase interface {
	...
	GetEventPlayerInfo(ctx context.Context, userId string, eventId string) (*eventModel.EventPlayerInfo, error)
}

func New(log *slog.Logger, uc UseCase) http.HandlerFunc {
	return func(writer http.ResponseWriter, request *http.Request) {
		const op = "handlers.event.getEventPlayerInfo"
