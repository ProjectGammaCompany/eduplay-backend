...
type UseCase interface {
	...
	PutEventBlock(ctx context.Context, pd *eventModel.PutEventBlockIn) (string, error)
}
...
func New(log *slog.Logger, uc UseCase) http.HandlerFunc {
	return func(writer http.ResponseWriter, request *http.Request) {
		...
		var req eventModel.PutEventBlockIn
		...
		id, err := uc.PutEventBlock(request.Context(), &req)
