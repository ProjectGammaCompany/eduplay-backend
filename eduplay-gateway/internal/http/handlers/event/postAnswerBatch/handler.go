...
type UseCase interface {
	PostAnswerBatch(ctx context.Context, answerBatch *eventModel.AnswerBatch) (string, error)
...
func New(log *slog.Logger, uc UseCase) http.HandlerFunc {
	return func(writer http.ResponseWriter, request *http.Request) {
		const op = "handlers.event.postAnswerBatch"
		...
		var req eventModel.AnswerBatch
		...
		ret, err := uc.PostAnswerBatch(request.Context(), &req)
