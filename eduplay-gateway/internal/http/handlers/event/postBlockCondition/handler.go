...
type UseCase interface {
	...
	PostBlockCondition(ctx context.Context, pd *eventModel.Condition) (*eventModel.PostConditionOut, error)
}

func New(log *slog.Logger, uc UseCase) http.HandlerFunc {
	return func(writer http.ResponseWriter, request *http.Request) {
		const op = "handlers.event.postBlockCondition"
		...
		req.PreviousBlockId = blockId

		ret, err := uc.PostBlockCondition(request.Context(), &req)
